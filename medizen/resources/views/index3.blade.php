				...
				<div class="col-xxl-7 col-xl-7 col-md-11 order-2 order-lg-1">
					<div class="hero-content-version3">
						...
						<h1 class="black wow fadeInUp" data-wow-delay="0.6s">
							...
							Services<br> & Surgery
							<img src="assets/img/banner/icon3_1.svg" alt="icon" class="img-icon">
						</h1>
			...
			<div class="feature-wrapper3">
				...
				<div class="row g-4">
					<div class="col-xl-9 col-lg-8 wow fadeInUp" data-wow-delay="0.9s">
						<div class="feature-inner-items2 reveal-left bg-cover rounded-4" style="background-image: url('assets/img/feature/featureThumb3_2.png');">
							<div class="content">
				...
				<div class="row gx-0 gy-5 align-items-end">
					<div class="col-lg-6 order-lg-0 order-1">
						<div class="appointment-thumb reveal-left">
							<img src="assets/img/appiontment/appiontmentThumb3_1.png" alt="img" class="w-100 rounded-2">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="section-title">
							...
							<div class="section-title">
								...
								<div class="btn-button">
									<div class="appoinment-btn">
										<a href="doctor-details.html" class="common-btn box-style first-box p1-bg d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s">
											Book An Appiontment
											<img src="assets/img/icon/arrow-right-black.png" alt="icon">
										</a>
									</div>
									<div class="author-icon">
										<div class="icon">
											<svg width="49" height="48" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
												<rect x="1.5" y="1" width="46" height="46" rx="23" stroke="white" stroke-opacity="0.4" stroke-width="2" />
